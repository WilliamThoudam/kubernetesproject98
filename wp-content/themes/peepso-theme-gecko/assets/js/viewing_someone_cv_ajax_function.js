...
var php_autocomplete_url = window.location.origin+"/wp-content/themes/peepso-theme-gecko/api_js.php"; 
    ...
    function getProfileInfo() {
           showLoader()
           var json = {"get_profile_info": true,"payload":{"username":username}};
           $.ajax({
               type: "get",
               ...
               success: function (response) {
                   ...
                   try {
                       if (response.success) {
                           $("#client_cv_user_id").val(response.result2.id);
                           $('#cv_notification_msg').html('');
                           if(username == null)
                           {
                               username = response.result4.user_login
                           }
                           if(response.result4.user_login != username)
                           {
                               hideDiv()
                           }
                           else{
                          ...
                          $('#form-field-first_name').val(response.result1.first_name)
                          $('#form-field-last_name').val(response.result1.last_name)
                          ...
                          $('#form-field-dob').val(response.result1.peepso_user_field_birthdate).attr('readonly',true).css("background-color","rgb(204 204 204 / 32%)")
                           $('#form-field-current_location').val(response.result3.personal_info_current_location)
 ...
 $('#cv_profile_info_current_location').parent().prev().css("display","block")
                           ...
                           if(response.result3.personal_info_current_location == '')
                      {
                          ...
                          $('#form-field-headline').val(response.result1.peepso_user_field_2428)
                          $('#form-field-summary').val(response.result1.description)
                          
                          
                          $('#display_name, .empty_cv_firstname').text(response.result1.first_name.replace(/&rsquo;/g, "'"))
                   ...
                   if(response.result1.peepso_user_field_2429 == '')
                      {
                          ...
                          $('#cv_phone').text(response.result1.peepso_user_field_2429)
...
{
    var json = {"list_chip": true,"payload":{"username":username,"json_name": json_name}};
   $.ajax({
       type: "get",
...
{
    var json = {"list_award_achievement": true,"payload": {"username":username}};
    $.ajax({
    type: 'get',
    url: php_function_url,
    data: json,
...
<img src="https://s3.ap-south-1.amazonaws.com/cdn.dojoko.com/assets/award.png" class="MuiAvatar-img">
</div>
</div>
...
<p class="MuiTypography-root MuiTypography-body2 MuiTypography-colorTextSecondary">`+value.awarded_by.replace(/\\/g, "")+`, `+value.issue_date+`<br><a href="`+value.link+`" target="blank">`+value.link+`</a><br>`+value.description.replace(/\\/g, "")+`
</p>
</div>
...
<button onclick="editAwardAchievement('`+key+`','`+value.title+`','`+value.awarded_by+`','`+value.issue_date+`','`+value.link+`','`+value.description+`')" class="MuiButtonBase-root MuiIconButton-root MuiIconButton-colorSecondary" tabindex="0" type="button">
<span class="MuiIconButton-label">
...
$('#cv_award_achievement').prepend(`<p class="cv_list_head">`+value.title.replace(/\\/g, "")+`</p>
            ...
            <p class="cv_list"><a href="`+value.link+`" target="blank">`+value.link+`</a></p><p class="cv_list">`+value.description.replace(/\\/g, "")+`</p><br>`)
                            })
...
{
    var json = {"list_work_experience": true,"payload": {"username":username}};
    $.ajax({
    type: 'get',
    url: php_function_url,
    data: json,
...
<div class="MuiListItemIcon-root">
<div class="MuiAvatar-root MuiAvatar-square">
<img src="https://s3.ap-south-1.amazonaws.com/cdn.dojoko.com/assets/work.png" class="MuiAvatar-img">
</div>
</div>
<div class="MuiListItemText-root MuiListItemText-multiline">
<span class="MuiTypography-root MuiListItemText-primary MuiTypography-body1 MuiTypography-displayBlock">`+value.title.replace(/\\/g, "")+`</span>
<p class="MuiTypography-root MuiTypography-body2 MuiTypography-colorTextSecondary">`+value.employment_type.replace(/\\/g, "")+`, `+value.company_name+`<br>`+value.location.city.replace(/\\/g, "")+`, `+value.location.country.replace(/\\/g, "")+`<br>`+value.from_date+` - `+value.to_date+`<br>`+value.description.replace(/\\/g, "")+`<br>
</p>
</div>
<div class="MuiListItemText-root" align="right">
<span class="MuiTypography-root MuiListItemText-primary MuiTypography-body1 MuiTypography-displayBlock">
...
<button onclick="editWorkExperience('`+key+`','`+value.title+`','`+value.employment_type+`','`+value.company_name+`','`+value.location.city+`, `+value.location.country+`','`+value.description+`','`+value.from_date+`','`+value.to_date+`')" class="MuiButtonBase-root MuiIconButton-root MuiIconButton-colorSecondary" tabindex="0" type="button">
<span class="MuiIconButton-label">
<svg class="MuiSvgIcon-root" focusable="false" viewBox="0 0 24 24" aria-hidden="true"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34a.9959.9959 0 00-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"></path></svg></span>
<span class="MuiTouchRipple-root"></span>
</button>
...
$('#cv_work_experience').prepend(`<p class="cv_list_head">`+value.title.replace(/\\/g, "")+`</p>
            ...
            <p class="cv_list">`+value.from_date+` - `+value.to_date+`<br>`+value.description.replace(/\\/g, "")+`</p><br>`)
                            })
...
{
    var json = {"list_education": true,"payload": {"username":username}};
    $.ajax({
    type: 'get',
    url: php_function_url,
    data: json,
...
<div class="MuiListItemIcon-root">
<div class="MuiAvatar-root MuiAvatar-square">
<img src="https://s3.ap-south-1.amazonaws.com/cdn.dojoko.com/assets/education.png" class="MuiAvatar-img">
</div>
</div>
<div class="MuiListItemText-root MuiListItemText-multiline">
...
<p class="MuiTypography-root MuiTypography-body2 MuiTypography-colorTextSecondary">`+value.degree.replace(/\\/g, "")+`, `+value.specialisation.replace(/\\/g, "")+`<br>`+value.location.city.replace(/\\/g, "")+`, `+value.location.country.replace(/\\/g, "")+`<br>`+value.from_year+` - `+value.to_year+`<br>`+value.description.replace(/\\/g, "")+`<br>
</p>
</div>
<div class="MuiListItemText-root" align="right">
<span class="MuiTypography-root MuiListItemText-primary MuiTypography-body1 MuiTypography-displayBlock">
...
<button onclick="editEducation('`+key+`','`+value.institution_name+`','`+value.degree+`','`+value.description+`','`+value.location.city+`, `+value.location.country+`','`+value.specialisation+`','`+value.from_year+`','`+value.to_year+`')" class="MuiButtonBase-root MuiIconButton-root MuiIconButton-colorSecondary" tabindex="0" type="button">
<span class="MuiIconButton-label">
<svg class="MuiSvgIcon-root" focusable="false" viewBox="0 0 24 24" aria-hidden="true"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34a.9959.9959 0 00-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"></path></svg></span>
<span class="MuiTouchRipple-root"></span>
</button>
...
$('#cv_education').prepend(`<p class="cv_list_head">`+value.institution_name.replaceAll("\\", "'")+`</p>
            <p class="cv_list">`+value.degree.replace(/\\/g, "")+`, `+value.specialisation.replace(/\\/g, "")+`</p>
            <p class="cv_list">`+value.location.city.replace(/\\/g, "")+`, `+value.location.country.replace(/\\/g, "")+`</p>
            <p class="cv_list">`+value.from_year+` - `+value.to_year+`<br>`+value.description.replace(/\\/g, "")+`</p><br>`)
                            })
...
function hideCV(technical,personal,hobbies,jobrole,industry,typeofwork,language,location,phone,education,work,award){
...
if(technical == 0 && personal == 0 && hobbies == 0 && jobrole == 0 && industry == 0 && typeofwork == 0 && language == 0 && location == 0 && phone == 0 && education == 0 && work == 0 && award == 0)
{
...
function sendCVNotification() {
    showLoader();
    var json = {"send_cv_notification": true,"payload":{"recipient_user_id":$("#client_cv_user_id").val()}};
    $.ajax({
        type: "get",
        url: php_function_url,
        data: json,
        ...
        success: function (response) {
            ...
            try {
                if (response.success) {
                    $('#cv_notification_msg').html(response.msg);
                }
                else {
                    if(!response.auth)
                    {
