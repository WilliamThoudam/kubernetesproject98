            ...
            <section
                ...
                <div class="eael-login-form-wrapper eael-lr-form-wrapper style-2 <?php echo esc_attr( $icon_class ); ?>">
					...
					if ( $show_logout_link && is_user_logged_in() && ! $this->in_editor ) {
						...
						$logged_in_msg = sprintf( __( 'You are logged in as %s. ', 'essential-addons-for-elementor-lite' ), wp_get_current_user()->display_name );
						printf( '%1$s   (<a href="/#">%3$s</a>)', $logged_in_msg, esc_url( wp_logout_url() ), __( 'My Feed', 'essential-addons-for-elementor-lite' ) );
					} else {
