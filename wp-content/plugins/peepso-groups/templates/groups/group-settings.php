        ...
        <div class="ps-group__edit-fields">
            ...
            <div class="ps-group__edit-field-row">
              <div class="ps-group__edit-field-header">
                <div class="ps-group__edit-field-title">
                  <span><?php if($parent_id != 0){echo __('Channel Name','groupso');}else{echo __('Group Name', 'groupso');}?></span>
              ...
              <div class="ps-group__edit-field-form ps-js-group-name-editor" style="display:none">
                <div class="ps-input__wrapper">
                  ...
                  <div class="ps-form__chars-count"><span class="ps-js-limit"><?php echo PeepSoGroup::$validation['name']['maxlength'];?></span> <?php echo __('Characters left', 'groupso'); ?></div>
                </div>
              </div>
              <?php } ?>
            </div>
          ...
          <div class="ps-group__edit-field ps-group__edit-field--desc ps-js-group-desc">
            <div class="ps-group__edit-field-row">
              <div class="ps-group__edit-field-header">
                <div class="ps-group__edit-field-title">
                  <span><?php if($parent_id != 0){echo __('Channel Description','groupso');}else{echo __('Group Description', 'groupso');}?></span>
                  <span class="ps-group__edit-field-required">*</span>
                </div>
              ...
              <div class="ps-group__edit-field-form ps-js-group-desc-editor" style="display:none">
                <div class="ps-input__wrapper">
                  ...
                  <div class="ps-form__chars-count"><?php echo PeepSoGroup::$validation['description']['maxlength'];?></span> <?php echo __('Characters left', 'groupso'); ?></div>
                </div>
              </div>
              <?php } ?>
            </div>
              ...
              <div class="ps-group__edit-field-header">
                <div class="ps-group__edit-field-title">
                  ...
                  <div class="ps-group__edit-field-note">
                    <?php
                    if($group->is_open) { echo __('Has no effect on Site Administrators', 'groupso'); }
                    if($group->is_closed) { echo __('If enabled users can join the group after the owner accepts the request', 'groupso'); }
                      ?>
                  </div>
                </div>
            ...
            <div class="ps-group__edit-field-row">
              <div class="ps-group__edit-field-header">
                <div class="ps-group__edit-field-title">
                  ...
                  <div class="ps-group__edit-field-note">
                    <?php echo __('If disabled only owners and managers can make posts to the group.
','groupso'); ?>
                  </div>
                </div>
            ...
            <div class="ps-group__edit-field-row">
              <div class="ps-group__edit-field-header">
                <div class="ps-group__edit-field-title">
                  ...
                  <div class="ps-group__edit-field-note">
                    <?php echo __('If disabled only owners and managers can like and comment.
','groupso'); ?>
                  </div>
                </div>
