...
// To get the All group and My groups tab in Group Main page
		...
		<div class="ps-groups">
			<?php if(get_current_user_id() || (get_current_user_id() == 0 && $allow_guest_access)) { ?>
				...
				<div class="ps-tabs ps-members__tabs ps-tabs--arrows">
						<div class="ps-tabs__item ps-members__tab ps-tabs__item--active">
								<a href="#">All Groups</a>
						</div>

						<div class="ps-tabs__item ps-members__tab ">
								<a href="<?php echo $profile_url; ?>groups">My Groups</a>
						</div>
