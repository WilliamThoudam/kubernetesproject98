...
class PeepSoGroups
{
	...
	public function get_groups($offset, $limit, $order_by, $order, $search, $user_id = 0, $category = 0, $gid)
	{
		global $wpdb;
		...
		if((isset($search) && $search != null) || (isset($user_id) && $user_id != 0) || (isset($category) && $category != 0))
		{
			$args = array(
