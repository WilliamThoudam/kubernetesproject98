...
<div id="wpf-cat-<?php echo $cat['forumid'] ?>" class="wpfl-4">
    ...
    <div class="wpf-head-bar">
        <div id="wpf-buttons-<?php echo $cat['forumid'] ?>" class="wpf-head-bar-left wpf-load-threads">
            <span class="wpf-forums"><i class="fas <?php echo ( WPF()->forum->options['layout_threaded_intro_topics_toggle'] ? 'fa-chevron-up' : 'fa-chevron-down' ) ?>"></i> <?php wpforo_phrase( 'Category' ) ?></span>
    ...
    <div class="wpf-threads">
        <div class="wpf-threads-head">
            ...
            <div class="wpf-head-box wpf-thead-date"><?php wpforo_phrase( 'Updated' ) ?>&nbsp;</div>
        </div>
