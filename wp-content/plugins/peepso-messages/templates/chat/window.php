		...
		<div class="ps-chat__window-inner">
			<div class="ps-chat__window-header ps-js-chat-window-header">
				...
				<div class="ps-chat__window-header-actions">
					<div class="ps-chat__window-header-action ps-tip ps-tip--arrow ps-js-min-options" data-id="{id}" aria-label="<?php echo __('Switch View', 'msgso');?>">
						<i class="gcis dojokoWindowMin_Max"></i>
					</div>
