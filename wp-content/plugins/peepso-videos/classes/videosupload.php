...
class PeepSoVideosUpload
{
	...
	public function notify_owner($post_id, $post_author, $success=TRUE)
	{
        ...
        if ($success) {
            ...
            PeepSoMailQueue::add_notification($post_author, $data, $notification_message, 'video_conversion_complete', 'video_conversion_complete', PeepSoVideos::MODULE_ID);
            ...
            PeepSoMailQueue::add_notification($post_author, $data, $notification_message, 'video_conversion_failed', 'video_conversion_failed', PeepSoVideos::MODULE_ID);
