...
class PeepSoConfigSectionvideos extends PeepSoConfigSectionAbstract {
	...
	private function video_uploads() {
        ...
        $this->set_field('videos_elastic_transcoder_separator',__('AWS Elastic Transcoder Integration','vidso'), 'separator');
