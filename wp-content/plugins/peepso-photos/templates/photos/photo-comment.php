...
?>
<a class="ps-media ps-media--photo ps-media-photo <?php if ($is_gif) { echo 'ps-media--gif'; } ?> ps-js-photo" data-id="<?php echo $act_id; ?>" href="<?php echo $photo_url; ?>" onclick="<?php echo $onclick; ?>" rel="post-<?php echo $act_id; ?>">
