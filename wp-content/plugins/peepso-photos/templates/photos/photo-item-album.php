								...
								<?php
									switch (intval($album->pho_album_acc)) {
										case PeepSo::ACCESS_PUBLIC:
												# code...
												$privacy = "<i class='gcis gci-globe-americas ps-tip ps-tip--inline' aria-label=" . __('Public', 'picso') . "></i>";
												break;

										case PeepSo::ACCESS_MEMBERS:
												# code...
												$privacy = "<i class='gcis gci-user-friends ps-tip ps-tip--inline' aria-label=" . __('Members only', 'picso') . "></i>";
												break;

										case PeepSo::ACCESS_PRIVATE:
												# code...
												$privacy = "<i class='gcis gci-lock ps-tip ps-tip--inline' aria-label=" . __('Private', 'picso') . "></i>";
												break;

										default:
												# code...
										if (class_exists('PeepSoFriendsPlugin')) {
											$privacy = "<i class='gcis gci-user ps-tip ps-tip--inline' aria-label=" . __('Friends Only', 'picso') . "></i>";
										} else {
											$privacy = "<i class='gcis gci-globe-americas ps-tip ps-tip--inline' aria-label=" . __('Public', 'picso') . "></i>";
										}
