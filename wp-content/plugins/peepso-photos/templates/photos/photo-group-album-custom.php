...
<div class="peepso">
  ...
  <div class="ps-page ps-page--group ps-page--group-album-custom">
    ...
    <div class="ps-album__comments">
      ...
      <div class="ps-comments">
        <div class="ps-comments__inner cstream-respond wall-cocs" id="wall-cmt-<?php echo $act_id; ?>">
            <div class="ps-comments__list comment-container ps-js-comment-container ps-js-comment-container--<?php echo $act_id; ?>" data-act-id="<?php echo $act_id; ?>">
