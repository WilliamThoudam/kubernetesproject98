...
class PeepSo3_REST_V1_Endpoint_Search extends PeepSo3_REST_V1_Endpoint {
    ...
    public function __construct() {
        ...
        $this->results['meta'] = array(
            ...
            'config' => [
                'items_per_section' => $PeepSo3_Input->int('items_per_section', 2),
                'max_length_title' => $PeepSo3_Input->int('items_per_section', 50),
                'max_length_text' => $PeepSo3_Input->int('items_per_section', 100),
            ],
        );
    }
