...
<div class="ps-focus <?php echo $use_small_cover ? 'ps-focus--small' : ''; ?> <?php echo $focus_class; ?> ps-js-focus ps-js-focus--profile ps-js-focus--<?php echo $PeepSoUser->get_id() ?>">
	<div class="ps-focus__cover ps-js-cover">
		...
		<div class="ps-avatar ps-avatar--focus ps-focus__avatar ps-js-avatar">
			<a href="#" onclick="peepso.simple_lightbox('<?php echo $PeepSoUser->get_avatar('orig');?>'); return false">
	...
	<div class="ps-focus__footer">
		<div class="ps-focus__info">
            ...
            <!-- CUSTOM COMMON INTEREST BUTTON ADDED BY RIYAZ START HERE-->
             <?php  $object = $PeepSoProfile->user;
          if($object->peepso_user['usr_id'] != get_current_user_id() ){ ?>
            <a class="cus_btn_anchor cus_btn_anchor_profile" href="javascript:show_interest(<?php echo $object->peepso_user['usr_id']; ?>)">
           ...
           <?php } ?>
           <!-- CUSTOM COMMON INTEREST BUTTON ADDED BY RIYAZ END HERE -->
			...
			<div class="ps-focus__actions ps-js-profile-actions-extra"><?php $PeepSoProfile->profile_actions_extra();
		...
		?>
		<div class="ps-focus__menu ps-js-focus__menu" id="ps-slider-rj">
