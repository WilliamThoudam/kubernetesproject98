<div class="peepso">
	<div class="ps-page ps-page--register ps-page--register-complete">
		<h1><?php echo __('Activate your account', 'peepso-core'); ?></h1>
        <br>
		<p>
			<?php
				if (PeepSo::get_option('registration_disable_email_verification', '0')) {
					...
					if (PeepSo::get_option('site_registration_enableverification', '0'))
						...
						echo __('Almost done... We have sent an activation link to your email. Please click on it to complete the sign up process!
Keep an eye on your inbox/spam folders. It should arrive in a couple of minutes.', 'peepso-core');
				}
			?>
		</p>
		<div class="ps-page__footer">
			<a href="<?php  echo get_bloginfo('wpurl'); ?>" class="ps-btn"><?php echo __('Back to Login', 'peepso-core'); ?></a>
		</div>
	</div>
</div>