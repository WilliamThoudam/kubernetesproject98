...
<div class="peepso">
  <div class="ps-page ps-page--register ps-page--register-resend">
    <h2><?php echo __('Resend Verification Email', 'peepso-core'); ?></h2>
    <p><?php echo __('Please enter your registered e-mail address below to receive an activation link.', 'peepso-core'); ?></p>
    <?php
		if (isset($error)) {
