	...
	<div class="dialog-content">
		<form class="ps-form ps-form--repost ps-form--vertical">
			<div class="ps-form__row">
				<textarea id="share-post-box" class="ps-input ps-input--textarea" placeholder="<?php echo __('Share your Thoughts, '.PeepSoUser::get_instance($user_id)->get_firstname(), 'peepso-core'); ?>"></textarea>
			</div>
			<div class="ps-form__row">
