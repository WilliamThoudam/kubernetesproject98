...
<div id="cus_px_member_tab_id" class="ps-tabs ps-members__tabs ps-tabs--arrows">
  ...
  <div class="ps-tabs__item ps-members__tab ">
		<a href="/similarities">Common Interests</a>
  </div>

  <div class="ps-tabs__item ps-members__tab ">
		<a href="<?php echo $profile_url; ?>friends"><?php echo __('My Connects', 'peepso-core'); ?></a>
  </div>
