  ...
  <div class="psw-login psw-login--<?php echo $view_class; ?>">
    ...
    <div class="psf-login">
        ...
        <input type="hidden" name="option" value="ps_users">
            ...
            <div class="ps-form__row ps-form__row--username ps-js-username-field">
                <div class="ps-form__field ps-form__field--icon">
                    <input class="ps-input ps-input--sm ps-input--icon" type="text" name="username" placeholder="<?php echo __('E-mail / Username', 'peepso-core'); ?>" mouseev="true"
            ...
            <div class="ps-form__row ps-form__row--submit ps-js-password-field">
                <div class="ps-form__field ps-form__field--submit">
                    <button type="submit" style="border:2px solid #00acc1;color:#00acc1;border-radius:20px;" id="cus_login_btn" class="ps-btn ps-btn--sm ps-btn--action ps-btn--login ps-btn--loading">
        ...
        <div class="psf-login__links">
			...
			<h1 class="cus_title_account elementor-heading-title elementor-size-default">Don't have an account  ?</h1>		</div>
              
                <a style="background-color:#00acc1;color:#ffffff;border-radius:20px;" class="psf-login__link psf-login__link--register" href="<?php echo PeepSo::get_page('register'); ?>"><?php echo __('Sign Up', 'peepso-core'); ?></a>
            <?php } ?>

          <!--  <a class="psf-login__link psf-login__link--recover" href="<?php //echo PeepSo::get_page('recover'); ?>"><?php //echo __('Forgot Password', 'peepso-core'); ?></a> -->

            <?php if(0 === $disable_registration) { ?>
                <a class="psf-login__link psf-login__link--activation ps-js-register-activation" href="<?php echo PeepSo::get_page('register'); ?>?resend"><?php echo __('Resend Verification Email', 'peepso-core'); ?></a>
            <?php } ?>
        </div>
    </div>
