...
?>
    ...
    <div class="psw-profile <?php if(isset($instance['show_cover']) && 1 == intval($instance['show_cover'])) { ?>psw-profile--cover<?php } ?> ps-js-widget-me">
        ...
        if($instance['user_id'] >0)
        {
            ...
            ?>
            <?php $theme_mode = get_user_meta(get_current_user_id(), 'peepso_gecko_user_theme', true); ?>
            <div class="psw-profile__header <?php if($theme_mode == 'gecko_dark_mode'){echo "dark_profile__header";}?>" >
            ...
            <!-- Following Code Removed by RJ for Left Nav Menu >
            ...
            <!-- By RJ <div class="psw-profile__menu-title">
                <?php //echo __('Community', 'peepso-core'); ?>
            </div> -->

            <div class="psw-profile__menu">
                <!-- Written By Hmanshu -->
                <input value="<?=get_current_user_id();?>" id="dojoko_user_id" hidden/>
				<input value="<?=get_user_meta(get_current_user_id(), 'peepso_gecko_user_theme', true);?>" id="dojoko_user_theme" hidden/>
                <?php
            ...
            //    }
                ...
                echo '<a href="/#" class="psw-profile__menu-item photos" id="dj_home"><i class="dojokoic_home_-35"></i>Home</a>';

                echo '<a href="/explore/#community" class="psw-profile__menu-item photos" id="dj_explore"><i class="dojokocompass1"></i>Explore</a>';

                echo '<a href="/members/" class="psw-profile__menu-item photos" id="dj_network"><i class="dojokonetwork"></i>Network</a>';

                echo '<a href="/groups/" class="psw-profile__menu-item photos" id="dj_groups"><i class="dojokousers"></i>Groups</a>';

                //echo '<a href="/events/" class="psw-profile__menu-item events" id="dj_events"><i class="dojokobullhorn"></i>Events</a>';

                 echo '<a href="/forums/" class="psw-profile__menu-item forums" id="dj_forums"><i class="dojokoquill"></i>Forums</a>';

                echo '<a href="/messages/" class="psw-profile__menu-item photos" id="dj_messages"><i class="dojokoenvelop"></i>Message</a>';

                echo '<a href="#" class="contactus psw-profile__menu-item feedback" id="contactus"><i class="gcis dojokofeed_back"></i>Feedback</a>';

                echo '<a href="/about-us" class="aboutus psw-profile__menu-item feedback" id="aboutus"><i class="gcis dojokoinfo"></i>About Us</a>';

                echo '<a href="" class="color_theme psw-profile__menu-item feedback" id="color_theme"><i class="gcis dojokoinfo"></i>Color Theme</a>';
                ?>
            </div>
        <?php } ?>
        <?php } else { ?>
