...
class PeepSoProfileShortcode
{
    ...
    public function enqueue_scripts()
    {
        ...
        // profile management
        wp_enqueue_script('peepso-page-profile', PeepSo::get_asset('js/page-profile.min.js'), array('peepso'), PeepSo::PLUGIN_VERSION, TRUE);
        ...
        add_filter('peepso_data', function( $data ) {
            ...
            $profile_data = array(
                ...
                'text_error_filetype' => __('The file type you uploaded is not allowed. Only JPEG/PNG allowed.', 'peepso-core'),
