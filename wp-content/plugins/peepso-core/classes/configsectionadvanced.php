...
class PeepSoConfigSectionAdvanced extends PeepSoConfigSectionAbstract
{
    ...
    private function stats() {
        ...
        $this->args('descript', Peepso3_Stats::$desc.'<br><br><a target="_blank" href="'.admin_url('admin.php?page=peepso_config&tab=advanced&peepso_stats_details').'">What is being tracked?</a>');
        $this->set_field(
            'optin_stats',
    ...
    private function _group_performance()
    {
        ...
        $this->args(
        	'descript',
	        __('Uses an experimental GROUP and SORT statements to speed up Activity loading on very large websites.', 'peepso-core')
	        . '<br/>' . __('This setting might cause posts and comments to stop showing on some servers.', 'peepso-core')
        );
        $this->set_field(
            'slow_query_fix',
	...
	private function _group_opengraph()
	{
        ...
        $this->set_field(
            ...
            __('Enable SEO Friendly links (BETA)', 'peepso-core'),
            'yesno_switch'
        );
