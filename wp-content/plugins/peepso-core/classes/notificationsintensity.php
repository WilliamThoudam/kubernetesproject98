...
class PeepSoNotificationsIntensity {
    ...
    public static function email_notifications_intensity_levels() {
        $levels = array(
            ...
            1 => array(
                'label' => __('one minute', 'peepso-core'),
                'desc'=>sprintf(__('You will receive a summary of unread on-site notifications approximately %s.','peepso-core'), __('once a minute','peepso-core')),
            ),
    ...
    public static function user_email_notifications_intensity($user_id = 0) {
        ...
        $email_preference = get_user_option('peepso_email_intensity', $user_id);
