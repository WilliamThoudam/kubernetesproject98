...
//			}
	...
	public function get_follower_status($passive_user_id, $active_user_id = NULL)
	{
		...
		$icon = 'eye-off';
		$extra = ' data-user-id="' . $passive_user_id . '" data-text-hover="' . esc_attr( __('Start following', 'friendso') ) . '"';
		...
		if ($PeepSoUserFollower->follow) {
			...
			$icon = 'eye';
			$extra = ' data-user-id="' . $passive_user_id . '" data-text-hover="' . esc_attr( __('Stop following', 'friendso') ) . '"';
		}
