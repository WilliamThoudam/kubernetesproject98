	...
	public function accept_request(PeepSoAjaxResponse $resp)
	{
		...
		if ($result) {
			...
			foreach ($user_transient as $user_transient_id) {
				$mayfly_upcoming_birthday = 'peepso_cache_widget_friendsupcomingbirthday_'. $user_transient_id;
	            $mayfly_save_date = 'peepso_cache_widget_friendsupcomingbirthday_savedate_'. $user_transient_id;
	            $mayfly_birthday = 'peepso_cache_widget_friendsbirthday_'. $user_transient_id;
	        	$mayfly_save_date_birthday = 'peepso_cache_widget_friendsbirthday_savedate_'. $user_transient_id;
	        	$mayfly_list_friends = 'peepso_cache_widget_friendslist_'. $user_transient_id;
            	$mayfly_save_date_list_friends = 'peepso_cache_widget_friendslist_savedate_'. $user_transient_id;

	        	PeepSo3_Mayfly::del($mayfly_upcoming_birthday);
	        	PeepSo3_Mayfly::del($mayfly_birthday);
	        	PeepSo3_Mayfly::del($mayfly_list_friends);
	        	PeepSo3_Mayfly::del($mayfly_save_date);
	        	PeepSo3_Mayfly::del($mayfly_save_date_birthday);
	        	PeepSo3_Mayfly::del($mayfly_save_date_list_friends);
			}
