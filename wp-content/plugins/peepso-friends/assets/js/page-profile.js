...
$(function () {
	...
	$header.on('click', '.ps-js-friend-follow, .ps-js-friend-unfollow', function (e) {
		let $btn = $(e.currentTarget),
			$loading = $btn.find('img'),
			userId = $btn.data('user-id'),
	...
	$header.on('mouseenter', '.ps-js-friend-follow, .ps-js-friend-unfollow', function (e) {
		let $btn = $(e.currentTarget),
			$label = $btn.find('span').last();
	...
	$header.on('mouseleave', '.ps-js-friend-follow, .ps-js-friend-unfollow', function (e) {
		let $btn = $(e.currentTarget),
			$label = $btn.find('span').last();
	...
	hooks.addAction('friend_followed', 'page_profile', updateActions);
	hooks.addAction('friend_unfollowed', 'page_profile', updateActions);
